     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
        ...
        started on your new carrier path! <span
        ...
        style='color:#1F497D'> </span></b>to let the learning begin! </span></b></b><i
        style='mso-bidi-font-style:normal padding-top:5px;'><p style="text-align: center; font-weight: bold;"><span style='font-size:13.0pt;
        font-family:"Arial",sans-serif;background:yellow;mso-highlight:yellow'>You
		  will log in to the AmeriBanc website and use the following.</span></p></i><p style="text-align: center;"><span style=" font-weight: bold; background-color: yellow; font-size:13.0pt;">USERNAME = {{$username}}<br />PASSWORD = abn.1234</span></p><p><span style='font-family:"Arial",sans-serif;
        mso-bidi-font-weight:bold'>You will need to go click on the “MY ABN Login” on the upper left hand side of the page and login with this Username and Password.  This will take you directly to your training portal. This should only take you a few hours. That is why you can do this from home before you start your new carrier so you have a better understanding of everything we do and much of what you will be doing at AmeriBanc.
        <o:p></o:p></span></p>
        ...
        <p class=MsoNormal><span style='font-family:"Arial",sans-serif'><o:p>&nbsp;</o:p></span></p>
        <p class=MsoNormal><span style='font-family:"Arial",sans-serif'>This training will be completed when you go through the live follow-up during your first few days in the office working with your manager.  Of course, your training won’t end then but rather be an ongoing experience, and will be outlined out more for you by our support team and manager.<o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-family:"Arial",sans-serif'><o:p>&nbsp;</o:p></span></p>
