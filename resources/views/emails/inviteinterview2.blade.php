 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=600
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
    ...
    href="http://www.ameribancsales.net/auth/login"><b style='mso-bidi-font-weight:normal'><span
    ...
    text-underline:none'><!--[if gte vml 1]><v:shapetype id="_x0000_t75"
     ...
     href="http://www.ameribancsales.net/auth/login" style='width:615pt;height:108pt;
     visibility:visible;mso-wrap-style:square' o:button="t">
     <v:imagedata src="Webinar%20Invitation_files/image001.png" o:title="image001.png@01CCBBFD"/>
    </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
    border=0 width=820 height=144 src="<?php echo $message->embed('assets/img/email/image001.png'); ?>"
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
        ...
        height:256.35pt'>
        <p class=MsoNormal><b><i><u><span style='font-size:11.0pt;font-family:
        "Arial",sans-serif;color:red'><o:p><span style='text-decoration:none'></span></o:p></span></u></i></b></p>
        <p class=MsoNormal align=center style='text-align:center'><b><i><u><span
        style='font-family:"Arial",sans-serif;color:red'>Your 2<sup>nd</sup>
        interview will be {{$interviewdate}}<span style='background:white'>&nbsp;at
        {{$interviewtime}} CST,&nbsp;</span></span></u></i></b><span
        class=apple-converted-space><b><i><span style='font-family:"Arial",sans-serif;
        color:red;background:white'>&nbsp;<o:p></o:p></span></i></b></span></p>
        <p class=MsoNormal align=center style='text-align:center'><b><i><u><span
        style='font-family:"Arial",sans-serif;color:red;background:white'>by
        calling {{$recruiter}}, @ {{$recruiter_phone}}, Ext: {{$recruiter_extension}}.<o:p></o:p></span></u></i></b></p>
        ...
        <p class=MsoNormal style='text-align:justify;text-justify:inter-ideograph'><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1;mso-bidi-font-weight:bold'><br>
        Hello </span><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;background:white'>{{$name}}</span><span style='font-size:
        11.0pt;font-family:"Arial",sans-serif;color:black;mso-themecolor:text1;
        mso-bidi-font-weight:bold'>,</span><span style='font-size:11.0pt;
        ...
        this opportunity!<o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1'><o:p>&nbsp;</o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1;mso-bidi-font-weight:bold'><span
        style='mso-spacerun:yes'>     </span>We called<span
        class=apple-converted-space>&nbsp;</span><span style='mso-bidi-font-style:
        italic'>you</span><span class=apple-converted-space>&nbsp;</span>because
        your level of sales experience matches our requirements for someone to
        be considered for this opportunity. So if we’ve made it this far
        together, then we have at least the beginning of a positive match, and
        that’s great.<br style='mso-special-character:line-break'>
        <![if !supportLineBreakNewLine]><br style='mso-special-character:line-break'>
        <![endif]><o:p></o:p></span></p>
        <p class=MsoNormal align=center style='text-align:center'><b><u><span
        style='font-size:16.0pt;font-family:"Arial",sans-serif;color:red'><a
        href="http://success.ameribancsales.net">HTTP://SUCCESS.AMERIBANCSALES.NET</a></span></u></b><u><span
        style='font-size:16.0pt;font-family:"Arial",sans-serif;color:red'><o:p></o:p></span></u></p>
        <p class=MsoNormal align=center style='text-align:center'><span
        style='font-size:14.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1'>Username: </span><span style='font-size:14.0pt;
        font-family:"Arial",sans-serif;color:black;background:yellow'>{{$username}}<o:p></o:p></span></p>
        <p class=MsoNormal align=center style='text-align:center'><span
        style='font-size:14.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1'>Password: </span><span style='font-size:14.0pt;
        font-family:"Arial",sans-serif;color:black;background:yellow'>{{$password}}</span><span
        style='font-size:14.0pt;font-family:"Arial",sans-serif;color:black;
        ...
        style='mso-spacerun:yes'>     </span>We would like you to take the time
        to review each section while you move through this interview process.
        This information will provide you with a jumpstart on your road to
        success with AmeriBanc. <b style='mso-bidi-font-weight:normal'><span
        style='color:#31859C;mso-themecolor:accent5;mso-themeshade:191;
        mso-style-textfill-fill-color:#31859C;mso-style-textfill-fill-themecolor:
        accent5;mso-style-textfill-fill-alpha:100.0%;mso-style-textfill-fill-colortransforms:
        lumm=75000'>Some of this content is only for our select candidates and
        it is not accessible to the general public. You can access it by using
        the login above.<o:p></o:p></span></b></span></p>
        ...
        11.0pt;font-family:"Arial",sans-serif;color:#31859C;mso-themecolor:
        accent5;mso-themeshade:191;mso-style-textfill-fill-color:#31859C;
        mso-style-textfill-fill-themecolor:accent5;mso-style-textfill-fill-alpha:
        100.0%;mso-style-textfill-fill-colortransforms:lumm=75000'><o:p>&nbsp;</o:p></span></i></b></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:#1F497D'>“Many have the will to win, but few have the will to
        prepare to win.” – Vince Lombardi<o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1;mso-bidi-font-weight:bold'><o:p>&nbsp;</o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1;mso-bidi-font-weight:bold'><span
        style='mso-spacerun:yes'>     </span>We base our decisions on who we
        recruit and offer a position to very carefully by utilizing the
        following criteria:</span><span style='font-size:11.0pt;font-family:
        "Arial",sans-serif;color:black;mso-themecolor:text1'><o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1'><o:p>&nbsp;</o:p></span></p>
        <p class=MsoNormal style='margin-left:.5in;text-indent:-.5in'><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1;mso-bidi-font-weight:bold'>1.)&nbsp;&nbsp;Appropriate
        Experience and Ability to Succeed in our Consultant Position</span><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1'><o:p></o:p></span></p>
        <p class=MsoNormal style='margin-left:.5in;text-indent:-.5in'><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1;mso-bidi-font-weight:bold'>2.)&nbsp;&nbsp;Mutual
        Desire and Enthusiasm to join AmeriBanc National in the Electronic
        Payments Industry</span><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1'><o:p></o:p></span></p>
        <p class=MsoNormal style='margin-left:.5in;text-indent:-.5in'><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1;mso-bidi-font-weight:bold'>3.)&nbsp;&nbsp;Territory
        Availability</span><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1'><o:p></o:p></span></p>
        <p class=MsoNormal style='margin-left:.5in;text-indent:-.5in'><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1;mso-bidi-font-weight:bold'>4.)&nbsp;&nbsp;Ability
        to Make a Concrete Commitment to AmeriBanc National</span><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif;color:black;
        mso-themecolor:text1'><o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        color:black;mso-themecolor:text1;mso-bidi-font-weight:bold'><o:p>&nbsp;</o:p></span></p>
        ...
        primarily<span class=apple-converted-space>&nbsp;</span>exclusive, so
        your preparation for our next conversation is very much appreciated.
        Please have all your questions written down so we can address all your
        inquiries, and we l</span><span style='font-size:11.0pt;font-family:
        "Arial",sans-serif;mso-bidi-font-weight:bold'>ook forward to hearing
        from you again<span class=apple-converted-space><span style='color:
        #1F497D'>.</span></span></span><span class=apple-converted-space><span
        ...
        11.0pt;font-family:"Arial",sans-serif;mso-bidi-font-weight:bold'>Again,
        thank you for your interest in AmeriBanc National and I look forward to
        learning more about you and your skill set when we speak again.</span><span
        style='font-size:11.0pt;font-family:"Arial",sans-serif'><o:p></o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        mso-bidi-font-weight:bold'><o:p>&nbsp;</o:p></span></p>
        <p class=MsoNormal><span style='font-size:11.0pt;font-family:"Arial",sans-serif;
        mso-bidi-font-weight:bold'>Best Regards,</span><span style='font-size:
        ...
        <p class=MsoNormal><a href="http://www.ameribancsales.net/auth/login"><span
        ...
        none'><!--[if gte vml 1]><v:shape id="Picture_x0020_6" o:spid="_x0000_i1034"
         ...
         href="http://www.ameribancsales.net/auth/login" style='width:94.5pt;height:30pt;
         visibility:visible;mso-wrap-style:square' o:button="t">
         <v:imagedata src="Webinar%20Invitation_files/image002.jpg" o:title="image002.jpg@01C9D478"/>
        </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
    ...
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
      ...
      style='mso-fareast-font-family:"Times New Roman";mso-no-proof:yes'><!--[if gte vml 1]><v:shape
       ...
       <v:imagedata src="Webinar%20Invitation_files/image003.jpg" o:title="facebook"
        croptop="-2632f" cropbottom="-6843f" cropright="-2731f"/>
       <o:lock v:ext="edit" aspectratio="f"/>
      </v:shape><![endif]--><![if !vml]><img border=0 width=20 height=19
      src="<?php echo $message->embed('assets/img/email/image004.jpg');?>" alt=facebook.png v:shapes="Picture_x0020_21"><![endif]></span><span
     ...
     <tr style='mso-yfti-irow:1'>
      ...
      style='mso-fareast-font-family:"Times New Roman";mso-no-proof:yes'><!--[if gte vml 1]><v:shape
       ...
       <v:imagedata src="Webinar%20Invitation_files/image005.png" o:title="twitter"/>
      </v:shape><![endif]--><![if !vml]><img border=0 width=19 height=19
      src="<?php echo $message->embed('assets/img/email/image006.png'); ?>" alt=twitter.png v:shapes="Picture_x0020_19"><![endif]></span><span
      style='mso-fareast-font-family:"Times New Roman"'><o:p></o:p></span></p>
      </td>
      <td valign=top style='padding:0in 0in 0in 0in'>
      <p class=MsoNormal style='line-height:150%'><span style='font-size:9.0pt;
     ...
     <tr style='mso-yfti-irow:2'>
      ...
      style='mso-fareast-font-family:"Times New Roman";mso-no-proof:yes'><!--[if gte vml 1]><v:shape
       ...
       style='width:14.25pt;height:14.25pt;visibility:visible;mso-wrap-style:square'>
       <v:imagedata src="Webinar%20Invitation_files/image007.png" o:title="linkedin"/>
      </v:shape><![endif]--><![if !vml]><img border=0 width=19 height=19
      src="<?php echo $message->embed('assets/img/email/image008.png'); ?>" alt=linkedin.png v:shapes="Picture_x0020_20"><![endif]><o:p></o:p></span></p>
      </td>
      <td valign=top style='padding:0in 0in 0in 0in'>
      <p class=MsoNormal style='line-height:150%'><span style='font-size:9.0pt;
      line-height:150%;font-family:"Arial",sans-serif;mso-fareast-font-family:
     ...
     <tr style='mso-yfti-irow:3'>
      ...
      style='mso-fareast-font-family:"Times New Roman";mso-no-proof:yes'><!--[if gte vml 1]><v:shape
       ...
       style='width:14.25pt;height:14.25pt;visibility:visible;mso-wrap-style:square'>
       <v:imagedata src="Webinar%20Invitation_files/image009.png" o:title="google"/>
      </v:shape><![endif]--><![if !vml]><img border=0 width=19 height=19
      src="<?php echo $message->embed('assets/img/email/image010.png'); ?>" alt=google.png v:shapes="Picture_x0020_23"><![endif]><o:p></o:p></span></p>
      </td>
      <td valign=top style='padding:0in 0in 0in 0in'>
      <p class=MsoNormal style='line-height:150%'><span style='font-size:9.0pt;
      line-height:150%;font-family:"Arial",sans-serif;mso-fareast-font-family:
     ...
     <tr style='mso-yfti-irow:4'>
      ...
      style='mso-fareast-font-family:"Times New Roman";mso-no-proof:yes'><!--[if gte vml 1]><v:shape
       ...
       style='width:14.25pt;height:14.25pt;visibility:visible;mso-wrap-style:square'>
       <v:imagedata src="Webinar%20Invitation_files/image011.png" o:title="youtube"/>
      </v:shape><![endif]--><![if !vml]><img border=0 width=19 height=19
      src="<?php echo $message->embed('assets/img/email/image012.png'); ?>" alt=youtube.png v:shapes="Picture_x0020_25"><![endif]><o:p></o:p></span></p>
      </td>
      <td valign=top style='padding:0in 0in 0in 0in'>
      <p class=MsoNormal style='line-height:150%'><span style='font-size:9.0pt;
      line-height:150%;font-family:"Arial",sans-serif;mso-fareast-font-family:
     ...
     <tr style='mso-yfti-irow:5;mso-yfti-lastrow:yes'>
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
        ...
        <p class=MsoNormal><a
        href="http://www.ameribancsales.net/auth/loginservices/merchant-loans"><span
        ...
        mso-no-proof:yes;text-decoration:none;text-underline:none'><!--[if gte vml 1]><v:shape
         ...
         href="http://www.ameribancsales.net/auth/loginservices/merchant-loans" style='width:111pt;
         height:105.75pt;visibility:visible;mso-wrap-style:square' o:button="t">
         <v:imagedata src="Webinar%20Invitation_files/image013.png" o:title=""/>
        </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
        border=0 width=148 height=141
        src="<?php echo $message->embed('assets/img/email/image036.png'); ?>" v:shapes="Picture_x0020_3"></span><![endif]></span></a><span
        style='mso-fareast-font-family:"Times New Roman"'><o:p></o:p></span></p>
        ...
        href="http://www.ameribancsales.net/auth/loginservices/mobile-solutions"><span
        ...
        yes;text-decoration:none;text-underline:none'><!--[if gte vml 1]><v:shape
         ...
         href="http://www.ameribancsales.net/auth/loginservices/mobile-solutions"
         style='width:113.25pt;height:107.25pt;visibility:visible;
         mso-wrap-style:square' o:button="t">
         <v:fill o:detectmouseclick="t"/>
         <v:imagedata src="Webinar%20Invitation_files/image037.png" o:title=""/>
        </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
        border=0 width=151 height=143
        src="<?php echo $message->embed('assets/img/email/image038.png'); ?>" v:shapes="Picture_x0020_13"></span><![endif]></span></a><span
        style='font-size:9.0pt;line-height:150%;font-family:"Arial",sans-serif;
        ...
        href="http://www.ameribancsales.net/auth/loginservices/credit-card-processing"><b
        ...
        text-underline:none'><!--[if gte vml 1]><v:shape id="Picture_x0020_10"
         ...
         href="http://www.ameribancsales.net/auth/loginservices/credit-card-processing"
         style='width:118.5pt;height:111.75pt;visibility:visible;
         mso-wrap-style:square' o:button="t">
         <v:fill o:detectmouseclick="t"/>
         <v:imagedata src="Webinar%20Invitation_files/image039.png" o:title=""/>
        </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
        border=0 width=158 height=149
        src="<?php echo $message->embed('assets/img/email/image040.png'); ?>" v:shapes="Picture_x0020_10"></span><![endif]></span></b></a><span
        style='font-size:9.0pt;line-height:150%;font-family:"Arial",sans-serif;
        mso-fareast-font-family:"Times New Roman";color:#505050'><o:p></o:p></span></p>
        </td>
       </tr>
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
    ...
    <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=663
     ...
     <tr style='mso-yfti-irow:1'>
      ...
      Regularly Visit <a href="http://www.ameribancsales.net/auth/login">Http://www.AmeriBancsales.net</a>
      ...
      text-underline:none'><!--[if gte vml 1]><v:shape id="Picture_x0020_2"
       ...
       <v:imagedata src="Webinar%20Invitation_files/image041.png" o:title=""/>
      </v:shape><![endif]--><![if !vml]><span style='mso-ignore:vglayout'><img
      border=0 width=209 height=79 src="<?php echo $message->embed('assets/img/email/image020.png'); ?>"
