		...
		<div class='row'>
			<article class="grid_3">
                <div class="triggerAnimation animated" data-animate="fadeInDown">
                    ...
                    <ul id="client-carousel-3" class="carousel-li">
                        <li><img src="/assets/img/pictures/iWL250-1.jpg" alt="VX520-1"/></li>
                        <li><img src="/assets/img/pictures/iWL250-2.jpg" alt="VX520-2"/></li>
                        <li><img src="/assets/img/pictures/iWL250-3.jpg" alt="VX520-3"/></li>
                    </ul>

                    <div class="carousel-nav-container">
                        <ul class="carousel-nav">
                            <li>
                                <a class="c_prev3" href="#"></a>
                            </li>
                            <li>
                                <a class="c_next3" href="#"></a>
                            </li>
                        </ul>
                    </div>
        ...
        <!--<div class='row'>
           <article class="grid_3">
                <div class="triggerAnimation animated" data-animate="fadeInDown">
                    ...
                    <ul id="client-carousel-4" class="carousel-li">
                    ...
                    <div class="carousel-nav-container">
                        <ul class="carousel-nav">
                            <li>
                                <a class="c_prev4" href="#"></a>
                            </li>
                            <li>
                                <a class="c_next4" href="#"></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <!--<div class='row'>
          	<article class="grid_3">
                <div class="triggerAnimation animated" data-animate="fadeInDown">
                    ...
                    <ul id="client-carousel-5" class="carousel-li">
                    ...
                    <div class="carousel-nav-container">
                        <ul class="carousel-nav">
                            <li>
                                <a class="c_prev5" href="#"></a>
                            </li>
                            <li>
                                <a class="c_next5" href="#"></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <article class="grid_3">
                <div class="triggerAnimation animated" data-animate="fadeInDown">
                    ...
                    <ul id="client-carousel-2" class="carousel-li">
                        <li><img src="/assets/img/pictures/iWL250-1.jpg" alt="iWL250-1"/></li>
                        <li><img src="/assets/img/pictures/iWL250-2.jpg" alt="iWL250-2"/></li>
                        <li><img src="/assets/img/pictures/iWL250-3.jpg" alt="iWL250-3"/></li>
                    </ul>
            ...
            <article class="grid_3">
                <div class="triggerAnimation animated" data-animate="fadeInDown">
                    ...
                    <ul id="client-carousel-1" class="carousel-li">
                        <li><img src="/assets/img/pictures/icT220-1.jpg" alt="iCT220-1"/></li>
                        <li><img src="/assets/img/pictures/icT220-2.jpg" alt="iCT220-2"/></li>
                        <li><img src="/assets/img/pictures/icT220-3.jpg" alt="iCT220-3"/></li>
                        <li><img src="/assets/img/pictures/icT220-4.jpg" alt="iCT220-4"/></li>
                    </ul>
				...
				<div class="triggerAnimation animated" data-animate="fadeInRight">
					<ul class="services-overview">
						<li>
							<h5>ICT220</h5>
							<p>
                                The iCT220 is a lightweight, stylish and self-contained device that will give the freedom to accept all types of electronic card payments without requiring a cash register or POS system interface. All iCT220 functions – from payment processing and receipt printing to settlement reporting and brand enhancement programs – operate from a single piece of equipment. This rugged, easy-to-use device also includes our advanced security measures.  The iCT220 meets the latest PCI PTS V3.0 Security standards and supports that latest international security algorithms.
							</p>
						</li>
					</ul>
				</div><!-- .triggeranimation.animated end -->
